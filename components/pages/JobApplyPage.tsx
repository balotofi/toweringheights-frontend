import { Stack, Flex, VStack, Heading, Text, Link, Icon } from "@chakra-ui/react"
                ...
                <VStack align={{base: 'flex-start', lg: 'center'}} gap={8}>
                    <Flex direction='column' gap={2}>
                        ...
                        <Flex gap={2} align={'center'}>
                            ...
                            <Text fontSize={{base: "sm", md: "md"}}>Form is currently unavailable. Kindly Send Your Application to 
