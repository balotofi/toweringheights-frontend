...
const HomePage = () => {
    ...
    return (
      <>
        <Flex justify='center' p={4} direction={{base: 'column', md: 'row-reverse'}} gap={4}>
          <ImageSlideShow />
          <Box p={{base: '1rem', md: '2rem'}} w={{xl: '50%'}}>
            <Text fontSize='xl' pb={2} className='paragraph' >Welcome to</Text>
            ...
            <Button
              ...
              size='lg' variant='solid' sx={{ px: '2rem', borderRadius: '3xl'}}
            >
              READ MORE
            </Button>
          </Box>
