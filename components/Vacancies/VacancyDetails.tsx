        ...
        <Box sx={detailBox}>
            <Flex direction='column' gap={3}>
                ...
                <Flex direction='column'>
                    <Text variant='vacancyDetail' className='paragraph'>Special Education Teacher (SY22-23)</Text>
                    <Text variant='vacancyDetail' className='paragraph'>Grade Level: All Grades</Text>
                    <Text variant='vacancyDetail' className='paragraph'>Start Date: August 2022</Text>
                    <Text variant='vacancyDetail' className='paragraph'>Locations: Boston and Lawrence, MA...</Text>
                </Flex>
            </Flex>  
            <Collapse in={isOpen} animateOpacity>
                ...
                <Flex direction='column' gap={2} align='start'>
                    ...
                    <Text variant='vacancyDetail' className='paragraph'>Candidates must have</Text>
                    <UnorderedList>
